...
const Panic = () => {
  ...
  return (
    ...
    <div  >
       <Flex  h="100vh" alignItems='center' flexDirection='column' bgGradient="linear(to-l, #f1a7f1, #fad0c4 )">
      ...
      >
            ...
            {isplaying ? (<Heading as="h1" fontWeight={"bold"} fontSize={58}>STOP</Heading>) :(<Heading as="h1" fontWeight={"bold"} fontSize={58}>START</Heading>) }
